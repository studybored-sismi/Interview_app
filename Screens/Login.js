  ...
  return (
    ...
    <View style={styles.container}>
       ...
       <Image source={require('../assets/group.png')} style={{margin:100,marginTop:60}}></Image>
        ...
        resizeMode:"contain",marginLeft:120,marginBottom:35}}></Image>
        </ImageBackground>
      ...
      <LinearGradient
        ...
        style={styles.button}>
        <Text style={styles.text} onPress={() => navigation.navigate("Profile")}>Login</Text>
      </LinearGradient>
      </TouchableOpacity>
      <View style={{flexDirection:'row',marginTop:30}}>
      
      <Text style={{color:"#858585"}} >Don't have an account ?  </Text>
      <Text style={{color:"#00B7C9"}}>Sign up</Text>
